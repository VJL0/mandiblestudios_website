            ...
            <div className="rounded-3xl bg-zinc-950 p-10">
              <div className="space-y-4 text-sm text-white/70">
                <p>
                  ...
                  prototype is a promise to the players who will one day call it
                  home.
                </p>
                <p>
        ...
        <section className="grid gap-10 rounded-3xl border border-white/10 bg-zinc-950/60 p-10 lg:grid-cols-[1fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="text-white/70">
              ...
              accessibility, and feel. From controller-first UI to collaborative
              case boards, we build tools that invite you in.
            </p>
            <p className="text-white/70">
              Our pipeline is transparent. We share prototypes, host playtests,
              and bring in new voices from the Philadelphia community as often
              as we can.
            </p>
          </div>
